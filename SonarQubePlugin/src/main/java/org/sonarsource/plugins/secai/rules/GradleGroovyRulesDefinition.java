package org.sonarsource.plugins.secai.rules;
...
public class GradleGroovyRulesDefinition implements RulesDefinition {

        public static final String REPOSITORY = "gradlegroovy";
        public static final String LANGUAGE = "gradlegroovy";
        public static final RuleKey RULE_ON_LINE_1 = RuleKey.of(REPOSITORY, "line1");

        @Override
        public void define(Context context) {
            NewRepository repository = context.createRepository(REPOSITORY, LANGUAGE).setName("My Custom Java Analyzer");
