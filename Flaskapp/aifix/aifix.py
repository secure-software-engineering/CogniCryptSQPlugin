...
from aifix.document_processor import DocumentProcessor
from aifix.vector_store_manager import VectorStoreManager
from aifix.llm_files import get_handler
...
def _parse_provider_and_model(s: str) -> Tuple[str, str | None]:
    ...
    """
    if not s:
        raise ValueError("llm_model (provider) must be specified: OPENAI | GEMINI")
